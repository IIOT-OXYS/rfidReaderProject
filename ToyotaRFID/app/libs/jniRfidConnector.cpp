...
JNIEXPORT jint JNICALL Java_RfidConnector_usbConnect(JNIEnv* env, jclass cls) {
    jint rarg = 0;
    jthrowable exc = NULL;
    try {
        int rvalue = usbConnect();
        rarg = (jint)rvalue;
    } catch (...) {
...
JNIEXPORT jshort JNICALL Java_RfidConnector_GetActiveID32(JNIEnv* env, jclass cls, jbyteArray arg0, jshort arg1) {
    signed char* ptr0 = arg0 == NULL ? NULL : env->GetByteArrayElements(arg0, NULL);
    jshort rarg = 0;
    jthrowable exc = NULL;
    try {
        short rvalue = GetActiveID32(ptr0, arg1);
        rarg = (jshort)rvalue;
    } catch (...) {
        exc = JavaCPP_handleException(env, 18);
    }
...
JNIEXPORT jint JNICALL Java_RfidConnector_USBDisconnect(JNIEnv* env, jclass cls) {
    jint rarg = 0;
    jthrowable exc = NULL;
    try {
        int rvalue = USBDisconnect();
        rarg = (jint)rvalue;
    } catch (...) {
        exc = JavaCPP_handleException(env, 18);
    }
...
JNIEXPORT jshort JNICALL Java_RfidConnector_SetDevTypeSrch(JNIEnv* env, jclass cls, jshort arg0) {
    jshort rarg = 0;
    jthrowable exc = NULL;
    try {
        short rvalue = SetDevTypeSrch(arg0);
        rarg = (jshort)rvalue;
    } catch (...) {
        exc = JavaCPP_handleException(env, 18);
    }
