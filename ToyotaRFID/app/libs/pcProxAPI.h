//  (C) COPYRIGHT RF IDeas, Inc., 2015 as an unpublished work.
//  All rights reserved.
...
USBWEJAPI_API short  USBWEJAPICC getCfgFlags2_iPad7();
...
USBWEJAPI_API BSHRT  USBWEJAPICC setCfgFlags2_iPad7(short value);
...
typedef short  (USBWEJAPICC *getCfgFlags2_iPad7)();
...
typedef BSHRT  (USBWEJAPICC *setCfgFlags2_iPad7)(short value);
...
//-----------------------------------------------------------------------------
#define CARDTYPE_ADVANT_CSN_LEGIC                          0x7F31  //; 13.56 MHZ
...
#define CARDTYPE_LEGIC_STANDARD_OR_ADVANT_CSN              0x6F03  //; 13.56 MHZ
#define CARDTYPE_MIFARE_CSN_PHILIPS_NXP                    0x7F41  //; 13.56 MHZ
#define CARDTYPE_MIFARE_EV1_CSN_SECURE_FILE   	 		   0x0202 //; 13.56 MHZ
#define CARDTYPE_MIFARE_EV1_SECURE_FILE_DATA 	 		   0x0201 //; 13.56 MHZ 
#define CARDTYPE_MiFARE_CLASSIC_SECURE_FILE_DATA           0x0301 //; 13.56 MHZ
#define CARDTYPE_MiFARE_CLASSIC_CSN_SECURE_FILE            0x0302 //; 13.56 MHZ
...
#define CARDTYPE_OFF                                       0x0000  //; ZERO IS NEVER USED A A CARD TYP
#define CARDTYPE_PARADOX                                   0xE902  //;
